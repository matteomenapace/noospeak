	...
	if ($result){
		...
		if (!mysql_numrows($result)) {
			...
			while ($row = mysql_fetch_array($result)){
				$input = $row['input'];
				//echo ($row['input']);
				$input =  "<div class='user'><div class='name'><b>Me</b><br></div><div class='text'>" . $input . "<br></div></div>";
				$conversation[] = $input;
				$response = $row['response'];
				$response = "<div class='google'><div class='name'><b>Google</b><br></div><div class='text'>" . $response . "<br></div></div>";
