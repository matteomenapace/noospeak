...
$searchString = $botresponse->response;
...
if (count($polishedDescriptions)>0){
	...
	*/
	...
	if ($googleResponse=="") $googleResponse = $botresponse->response;
	
} else $googleResponse = 	$botresponse->response;

//echo ("<br>Google response is <b>". $googleResponse . "</b>");


// LOG USER INPUT AND GOOGLE RESPONSE
g_logconversation($_POST['input'],$googleResponse);
