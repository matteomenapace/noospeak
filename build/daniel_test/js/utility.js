...
var callback = {
	...
	getranked : function(sentence){
		alert(sentence[0]+' Index: '+sentence[1]);
		loadResponse(sentence[0],results[sentence[1]].url,'google');
	}
}
...
function styleEntry(type,text,entryId,link,time,place,similarTopic) {
	...
	if (type=='google') {
	name='Google';
	entry = "<div class=\"last-entry\" id=\""+entryId+"\"><div class='name'>"+name+"</div><div class='text'><a href='"+link+"' target='_blank'>"+text+"</a></div><div class='info'>"+time+" "+place+" - </div><div class=\"more\"><a href='"+similarTopic+"'>More</a></div><div class=\"similar-topic\"><a href='"+similarTopic+"'>Similar Topic</a></div></div>";
	}
	else 
	{
		name='Me';
		entry = "<div class=\"last-entry\" id=\""+entryId+"\"><div class='name'>"+name+"</div><div class='text'>"+text+"</div><div class='info'>"+time+" "+place+" - </div></div>";
