...
<?php
	...
	/* Specify your SMTP Server, Port and Valid From Address */
  	ini_set("SMTP","mail.mmatteo.com");
  	ini_set("smtp_port","25");
  	ini_set("sendmail_from","matteomenapace@mmatteo.com");
	...
	else $echo .= "Ops! An error occurred while sending your message. Could you try again?</p>"; 
